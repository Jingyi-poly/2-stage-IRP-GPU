...
void Genetic::evolve(int maxIter, int maxIterNonProd, int nbRec)
{
	...
	int measure = 0;
	string temp;
	traces = true; // OU Policy 和 gurobi 对比时关闭
	if (!traces) {
...
void Genetic::gererPenalites()
{
	...
	// cout << "minValides: " << params->minValides << endl;
	// cout << "maxValides: " << params->maxValides << endl;
	// cout << "penalityCapa: " << params->penalityCapa << endl;
	// cout << "penalityLength: " << params->penalityLength << endl;
	// cin.get();
