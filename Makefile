...
OBJS2 = \
	...
	$(TARGETDIR)/Genetic.o \
        ...
        $(TARGETDIR)/OUPolicySolver.o \
        $(TARGETDIR)/MatrixSolver.o \
...
$(TARGETDIR)/OUPolicySolver.o: OUPolicySolver.h OUPolicySolver.cpp
	$(CCC) $(CCFLAGS) $(CPPFLAGS) -c OUPolicySolver.cpp -o $(TARGETDIR)/OUPolicySolver.o

$(TARGETDIR)/MatrixSolver.o: MatrixSolver.h MatrixSolver.cpp
	$(CCC) $(CCFLAGS) $(CPPFLAGS) -c MatrixSolver.cpp -o $(TARGETDIR)/MatrixSolver.o
