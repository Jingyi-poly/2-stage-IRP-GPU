...
private:
	...
	void crossPOX_OU_ptr(Individu *child1, Individu *child2, Individu *general_individu);

	void crossPOX_OU_day_1(Individu *child1, Individu *child2);
...
public:
	...
	Genetic(ParamsList *params_list, Population *population, clock_t ticks, bool traces, bool writeProgress);
	// destructeur
	~Genetic(void);
};
