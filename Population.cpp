...
void Population::education(Individu *indiv)
{
	...
	// cout << "penalityCapa: " << trainer->coutSol.evaluation-trainer->coutSol.fitness << endl;
	// cout << "after split" << endl;
	trainer->generalSplit();
	// cout << "penalityCapa: " << trainer->coutSol.evaluation-trainer->coutSol.fitness << endl;
	trainer->updateLS();
	// cout << "after updateLS" << endl;
	// cout << "penalityCapa: " << trainer->coutSol.evaluation-trainer->coutSol.fitness << endl;
	trainer->localSearch->runSearchTotal(false);
	// cout << "after runSearchTotal" << endl;
	// cout << "penalityCapa: " << trainer->coutSol.evaluation-trainer->coutSol.fitness<< endl;
	trainer->updateIndiv();
	// cout << "after updateIndiv" << endl;
	// cout << "penalityCapa: " << trainer->coutSol.evaluation-trainer->coutSol.fitness<< endl;
	// cout << "params->penalityCapa: " << params->penalityCapa << endl;
	// cout << "params->penalityLength: " << params->penalityLength << endl;
