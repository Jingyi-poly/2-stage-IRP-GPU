...
int LocalSearch::mutation1 ()
{
	...
	// dans le cas ou l'on est dans la meme route , le cout n'est pas calcul correctement en ralit
	// tout ce qu'on sait c'est que si il est ngatif c'est qu'il est bien rellement ngatif
...
// teste si x n'est pas un depot , et si x different de noeudV, et si noeudU pas dja apres noeudV
